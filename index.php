    ...
    <div class="container-fluid w-responsive mx-auto mb-5"><br>
        <div class="row">
            ...
            <div class="col-md-8" id="aboutMe">
                Thank you for taking the time to learn more about me and view my portfolio.
                My name is Robert Wood and I create quality applications, web, desktop and mobile.
                ...
                successful creations multiple clients. My area of skill may exist in one area, but I can adapt and overcome
                ...
                even more, than I already do and step up to make sure the job gets done and done correctly. I have worked in
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">PigDice</h5>
                            <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                            <p>
                                The web application was made primarily with JavaScript/JQuery, HTML and CSS.
                    ...
                    <div class="col-md-3 text-center">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li><i class="fas fa-phone mt-4 fa-2x"></i>
                                <p type="phone">253.223.3253</p>
                            </li>
                            <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                                <p><a href="mailto:rdrwood@gmail.com">rdrwood@gmail.com</p>
                            </li>
                        </ul>
                    </div>
                </div>
...
<script>
    ...
    var observer = new IntersectionObserver(function(entries) {
        if(entries[0].intersectionRatio === 0)
            ...
            document.getElementById("#right-stick").style.display = "none";
    }, { threshold: [0,1] });
