<?php
echo "<nav id='footer' class='navbar navbar-dark bg-dark'>
        <div class='col-4 text-light'> &copy; October 2019 </div>
        <div>
            <a href='https://github.com/woodrdk' target='_blank'>
                <i class='fa fa-github' style='font-size:48px;color:white'></i>
            </a>
            <a href='https://www.linkedin.com/in/robert-wood-jr-200180161/' target='_blank'>
